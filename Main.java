public class Main {
    ...
    public static double calcA3() {return((Math.sin(deltaPhi3)*Math.sin(deltaPhi3))+(Math.cos(p3)*Math.cos(p4)*(Math.sin(deltaLambda3)*Math.sin(deltaLambda3))));}
    public static double calcA4() {return((Math.sin(deltaPhi4)*Math.sin(deltaPhi4))+(Math.cos(p4)*Math.cos(p5)*(Math.sin(deltaLambda4)*Math.sin(deltaLambda4))));}
    public static double calcA5() {return((Math.sin(deltaPhi5)*Math.sin(deltaPhi5))+(Math.cos(p5)*Math.cos(p6)*(Math.sin(deltaLambda5)*Math.sin(deltaLambda5))));}
    public static double calcA6() {return((Math.sin(deltaPhi6)*Math.sin(deltaPhi6))+(Math.cos(p6)*Math.cos(p7)*(Math.sin(deltaLambda6)*Math.sin(deltaLambda6))));}
    public static double calcA7() {return((Math.sin(deltaPhi7)*Math.sin(deltaPhi7))+(Math.cos(p7)*Math.cos(p8)*(Math.sin(deltaLambda7)*Math.sin(deltaLambda7))));}
    public static double calcA8() {return((Math.sin(deltaPhi8)*Math.sin(deltaPhi8))+(Math.cos(p8)*Math.cos(p9)*(Math.sin(deltaLambda8)*Math.sin(deltaLambda8))));}
    public static double calcA9() {return((Math.sin(deltaPhi9)*Math.sin(deltaPhi9))+(Math.cos(p9)*Math.cos(p10)*(Math.sin(deltaLambda9)*Math.sin(deltaLambda9))));}
    public static double calcA10() {return((Math.sin(deltaPhi10)*Math.sin(deltaPhi10))+(Math.cos(p10)*Math.cos(p11)*(Math.sin(deltaLambda10)*Math.sin(deltaLambda10))));}
    public static double calcA11() {return((Math.sin(deltaPhi11)*Math.sin(deltaPhi11))+(Math.cos(p11)*Math.cos(p12)*(Math.sin(deltaLambda11)*Math.sin(deltaLambda11))));}
    public static double calcA12() {return((Math.sin(deltaPhi12)*Math.sin(deltaPhi12))+(Math.cos(p12)*Math.cos(p13)*(Math.sin(deltaLambda12)*Math.sin(deltaLambda12))));}
